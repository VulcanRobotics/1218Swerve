...
/**
 * This is the command class implementation of DriveToPosition, and this command does have an END
 * condition, meaning that it will deschedule once it has been completed.
 */
